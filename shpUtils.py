# Original written by Zachary Forest Johnson
# Downloaded from
# http://indiemaps.com/blog/2008/03/easy-shapefile-loading-in-python/
#
# Adapted by Andra Veraart
# for ICTLAB
...
def createRecord(fp):
        ...
        if record_number == '':
                # print 'doner'         # Andra: Not entirely sure why this was here
                return False
        ...
        for i in range(0,len(db[record_number+1])):
                ...
                if type(dbf_data[db[0][i]]) == str:
                    dbf_data[db[0][i]] = str.strip(dbf_data[db[0][i]])
        
        return {'location':shp_data, 'properties':dbf_data}
